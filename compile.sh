...
gcc ./code/main.c -o rng $include_path $lib_path graph_library.o rewiring.o annealingCk.o annealingCbar.o annealingTRI.o annealingPkkCk.o annealingPkkCbar.o annealingPkkTRI.o annealingKnn.o -lm -O2 -Wall -lgsl -lgslcblas
